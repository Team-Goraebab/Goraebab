  ...
  return (
    <>
      <div className="fixed bottom-6 left-1/2 transform -translate-x-1/2 z-[9]">
        <div className="bg-white rounded-xl shadow-lg p-2 flex gap-3 items-center">
          <Button
      ...
      {isHostModalOpen && <HostModal isOpen={isHostModalOpen} onClose={() => setIsHostModalOpen(false)} />}
